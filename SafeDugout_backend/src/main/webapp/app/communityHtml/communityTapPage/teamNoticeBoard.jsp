...
<title>불펜토크 공지 목록</title>
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/communityCss/communityTapPage/teamNoticeBoard.css">
<c:choose>
...
<%-- <script defer src="${pageContext.request.contextPath}/assets/js/communityJs/communityTapPage/teamNoticeBoard.js"></script> --%>
</head>
<body>
	<jsp:include
		...
		<div class="team-notice-container">
			...
			<div class="pagination">
				<ul>
					<c:if test="${prev}">
						<li><a
							href="${pageContext.request.contextPath}/community/teamCommunityFrontController.tc?category=board&action=notice&page=${startPage - 1}">&lt;</a></li>
					</c:if>
					...
					<c:if test="${next}">
						<li><a
							href="${pageContext.request.contextPath}/community/teamCommunityFrontController.tc?category=board&action=notice&page=${endPage + 1}">&gt;</a></li>
					</c:if>
				</ul>
			</div>
		</div>

...
<body>
  ...
  <main>
    ...
    <div class="team-news-container">
      ...
      <!-- 기사 원문 링크 -->
      <a href="${community.postLink}"><button>기사원문</button></a>
      <!-- 기사 작성일, 작성자 -->
      <div class="team-news-meta">
        <span class="team-news-date"><c:out value="${community.postDate}" /></span>
        <span class="team-news-reporter">
        	<c:out value= "${community.journalist}" />
        </span>
      </div>
      <!-- 뉴스 이미지 --> 
      <div class="team-news-image">
     	<img src="${pageContext.request.contextPath}/uploads/${community.imagePath}" />
      </div>
      <!-- 본문 -->

...
<header id="team-header">
  <div class="top-header">
    ...
    <div class="team-right-link">
      <a href="${pageContext.request.contextPath}/app/mainNotice/mainNoticeList.html" class="main-notice">
        [메인공지]: 불펜토크 사이트 이용 안내
      </a>
      ...
      <ul class="team-menu">
        ...
        <li class="nav-search">
          <form action="" method="get">
            ...
            <button onclick="location.href='${pageContext.request.contextPath}/app/communityHtml/communityTapPage/teamSearch.html'">

  ...
  <div class="modal-tradepolicy-footer">
    ...
    <div class="modal-window-footer">
      ...
      <ol>
        ...
        <li>신고 접수 방법: 사이트 푸터에 기재된 이메일(<a href="mailto:admin1234@gmail.com">admin1234@gmail.com</a>)로 접수합니다. 접수 시 거래정보(주문번호/게시물ID/거래일시 등)를 함께 제출해 주세요.</li>
      </ol>
		<br>
      ...
      <p>본 운영정책은 서비스 개선 및 법령 변경 등에 따라 변경될 수 있으며, 변경 시 운영팀은 사전 공지합니다.</p>
		<br>
      <h3>시행일</h3>
      <p>본 운영정책은 2025년 9월 4일부터 시행합니다.</p>
      <br>
    </div>
      </div>
    </div>

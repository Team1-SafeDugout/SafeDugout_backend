...
<head>
  ...
  <link rel="stylesheet" href="/webapp/assets/css/memberQuit/inputReason.css">
    ...
    <section class="buyList">
      ...
      <div>
        <ul>
          ...
          <li class="member-"> <a href="./../memberInformation/password.html"> 회원 정보 수정</a> </li>
          <li class="sidebar-elements"> <a href="./memberPassword.html"> 회원 탈퇴</a> </li>
        </ul>
      </div>
    </section>

    <section class="member-reason">
      <h3>회원 탈퇴</h3>
      <section>
        <li>탈퇴 사유</li>

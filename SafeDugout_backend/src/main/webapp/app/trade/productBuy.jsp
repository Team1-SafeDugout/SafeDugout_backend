                ...
                <div class="main-message-container">
                    ...
                    <div class="container-full">
                        <div class="container-left">
                            ...
                            <div class="point-amount">
                                <c:choose>
                                    <c:when test="${not empty sessionScope.memberPoint}">${sessionScope.memberPoint}</c:when>
                            ...
                            <div class="point-amount">
                                <c:choose>
                                    <c:when test="${not empty sellPostDetail.pricePoint}">${sellPostDetail.pricePoint}</c:when>
                                    <c:otherwise>0</c:otherwise>
                                </c:choose> 포인트
                            </div>
                        </div>
                        ...
                        <div class="container-right">
						    <c:forEach var="img" items="${sellPostDetail.attachment}">
						        <div class="product-img">
						            <img src="${img.attachmentPath != null ? img.attachmentPath : pageContext.request.contextPath + '/assets/img/tradeImg/default.jpg'}" alt="">
						        </div>
						    </c:forEach>
                            <div class="product-text">상품명: ${sellPostDetail.sellPostTitle}</div>
                            <div class="product-text">거래 방식: ${sellPostDetail.dealtypeName}</div>
                        </div>
                    </div>
                    ...
                    <div class="container-full">
                        <div class="container-left-bottom">
                            ...
                            <div class="point-amount">
                                <c:choose>
                                    <c:when test="${not empty sessionScope.memberPoint and not empty sellPostDetail.pricePoint}">
                                        ${sessionScope.memberPoint - sellPostDetail.pricePoint}
                                    </c:when>
                                    <c:otherwise>0</c:otherwise>
                                </c:choose> 포인트
                            </div>
                    ...
                    <div class="main-button-container">
                        ...
                        <a href="${pageContext.request.contextPath}/trade/sellPostFrontController2?category=allproduct&action=list">

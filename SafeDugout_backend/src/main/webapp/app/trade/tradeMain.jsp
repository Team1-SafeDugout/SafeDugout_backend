...
<body>
	...
	<form action="" method="get">
		...
		<div class="search-container">
			<!-- 검색어 입력칸 -->
			<input type="text" placeholder="검색어를 입력해주세요" id="searchWord">
			<!-- 검색 컨테이너 button 태그 -->
			...
			<section class="section-container">
				...
				<div class="team-bar">
					...
					<div class="team-bar-logo-container">
						...
						<div class="team-bar-logo">
							<a><img src="${pageContext.request.contextPath}/assets/img/communityImg/ssg.png" alt=""></a>
						</div>
						<div class="team-bar-logo">
							<a><img src="${pageContext.request.contextPath}/assets/img/communityImg/lg.png" alt=""></a>
						</div>
						<div class="team-bar-logo">
							<a><img src="${pageContext.request.contextPath}/assets/img/communityImg/doosan.png"
								alt=""></a>
						</div>
						<div class="team-bar-logo">
							<a><img src="${pageContext.request.contextPath}/assets/img/communityImg/WO.png" alt=""></a>
						</div>
						<div class="team-bar-logo">
							<a><img src="${pageContext.request.contextPath}/assets/img/communityImg/kia.png" alt=""></a>
						</div>
						<div class="team-bar-logo">
							<a><img src="${pageContext.request.contextPath}/assets/img/communityImg/SS.png" alt=""></a>
						</div>
						<div class="team-bar-logo">
							<a><img src="${pageContext.request.contextPath}/assets/img/communityImg/HH.png" alt=""></a>
						</div>
						<div class="team-bar-logo">
							<a><img src="${pageContext.request.contextPath}/assets/img/communityImg/nc.png" alt=""></a>
						</div>
						<div class="team-bar-logo">
							<a><img src="${pageContext.request.contextPath}/assets/img/communityImg/LT.png" alt=""></a>
						</div>
						<div class="team-bar-logo">
							<a><img src="${pageContext.request.contextPath}/assets/img/communityImg/kt.png" alt=""></a>
						</div>
					</div>
				</div>
				<!-- 로고 하단 컨테이너 -->
				<div class="page-bar">
					...
					<div class="page-bar-text">
						<!-- 조회 결과 - 검색어 -->
						<span class="big-text">[“<span id="searchWordText">검색어</span>”]
							검색 결과
						</span>
						<!-- 조회 결과 - 개수, 팀, 상품 종류 -->
						<span class="small-text"><span id="productCount">2134</span>개
							모든 팀 > 모든 상품 유형</span>
					</div>
					<!-- 페이지 버튼 컨테이너 -->

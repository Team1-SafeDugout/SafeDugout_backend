...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/admin/adminMenu/adminManageTeamYoutube.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/admin/adminHeader.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/admin/adminFooter.css">
...
<script defer
	src="${pageContext.request.contextPath}/assets/js/admin/adminMenu/adminManageTeamYoutube.js"></script>
</head>
...
<body>
	...
	<main>
		<section class="body-sidebar">
			<div class="sidebar-div-name">관리자 메뉴</div>
		...
		<section class="body-container">
			<div class="body-container-name">팀유튜브</div>
				...
				<div class="list-background">
					...
					<div class="pagination">
						<ul>
							...
							<c:if test="${prev}">
								<li><a
									href="${pageContext.request.contextPath}/admin/adminManageTeamYoutubeListOk.ad?page=${startPage - 1}"
									class="prev">&lt;</a></li>
							</c:if>
							...
							<c:forEach var="i" begin="${realStartPage}" end="${endPage}">
								<c:choose>
									<c:when test="${!(i == page) }">
										<li><a
											href="${pageContext.request.contextPath}/admin/adminManageTeamYoutubeListOk.ad?page=${i}">
												<c:out value="${i}" />
										</a></li>
									</c:when>
									<c:otherwise>
							...
							<c:if test="${next}">
								<li><a
									href="${pageContext.request.contextPath}/admin/adminManageTeamYoutubeListOk.ad?page=${endPage + 1}"
									class="next">&gt;</a>
							</c:if>
		...
		<section class="section-modal" id="section-modal">
			...
			<form action="/admin/adminCreatePostOk.ad?boardCategory=teamyoutube"
				method="post" id="modal-form" enctype="multipart/form-data">

				<div class="modal-input-text">
					<label for="youtube-url"> 유튜브 주소 : </label> <input type="url"
						id="youtube-url" name="youtubeUrl" required>
				</div>

				<div class="modal-input-text">
					<label for="youtube-title"> 유튜브 제목 : </label> <input type="text"
						id="youtube-title" name="youtubeTitle" required>
				</div>

				<div class="modal-input-radio">

					<input type="radio" id="lg" value="lg" name="team-categories"
						required> <label for="lg"> <img
						src="${pageContext.request.contextPath}/assets/img/communityImg/lg.png">
					</label> <input type="radio" id="hh" value="hh" name="team-categories"
						required> <label for="hh"> <img
						src="${pageContext.request.contextPath}/assets/img/communityImg/HH.png">
					</label> <input type="radio" id="lotte" value="lotte"
						name="team-categories" required> <label for="lotte">
						<img
						src="${pageContext.request.contextPath}/assets/img/communityImg/LT.png">
					</label> <input type="radio" id="ssg" value="ssg" name="team-categories"
						required> <label for="ssg"> <img
						src="${pageContext.request.contextPath}/assets/img/communityImg/ssg.png">
					</label> <input type="radio" id="kia" value="kia" name="team-categories"
						required> <label for="kia"> <img
						src="${pageContext.request.contextPath}/assets/img/communityImg/kia.png">
					</label> <input type="radio" id="kt" value="kt" name="team-categories"
						required> <label for="kt"> <img
						src="${pageContext.request.contextPath}/assets/img/communityImg/kt.png">
					</label> <input type="radio" id="nc" value="nc" name="team-categories"
						required> <label for="nc"> <img
						src="${pageContext.request.contextPath}/assets/img/communityImg/nc.png">
					</label> <input type="radio" id="samsung" value="samsung"
						name="team-categories" required> <label for="samsung">
						<img
						src="${pageContext.request.contextPath}/assets/img/communityImg/SS.png">
					</label> <input type="radio" id="doosan" value="doosan"
						name="team-categories" required> <label for="doosan">
						<img
						src="${pageContext.request.contextPath}/assets/img/communityImg/doosan.png">
					</label> <input type="radio" id="kiwoom" value="kiwoom"
						name="team-categories" required> <label for="kiwoom">
						<img

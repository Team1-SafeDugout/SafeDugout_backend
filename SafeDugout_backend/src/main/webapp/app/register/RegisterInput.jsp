      ...
      <form action="${pageContext.request.contextPath}/member/joinOk.me" method="post">
        ...
        <div class="main-form-box">
          ...
          <ul>
            ...
            <li>
              <!-- 입력 오류 메시지 -->
              <div class="main-input-error-message"><span class="requiredValue">* 필수 입력 값입니다.</span></div>
              <!-- 입력 컨테이너 -->
            ...
            <li>
              <!-- 입력 오류 메시지 -->
              <div class="main-input-error-message"><span class="requiredValue">* 필수 입력 값입니다.</span><span>* 아이디가 유효하지
                  않습니다.</span><span>* 아이디가 중복되었거나
                  중복 확인이 되지 않았습니다.</span></div>
              <!-- 입력 컨테이너 -->
              <div class="main-input-list">
                <!-- 입력 메시지 -->
            ...
            <li>
              <!-- 입력 오류 메시지 -->
              <div class="main-input-error-message"><span class="requiredValue">* 필수 입력 값입니다.</span><span>* 비밀번호가 유효하지
                  않습니다.</span></div>
              <!-- 입력 컨테이너 -->
              <div class="main-input-list">
            ...
            <li>
              ...
              <div class="main-input-list">
                ...
                <input type="password" placeholder="비밀번호를 재입력하세요" id="rePw">
              </div>
            </li>
            <!-- li 태그 -->
            <li>
            ...
            <li>
              <!-- 입력 오류 메시지 -->
              <div class="main-input-error-message"><span>* 인증번호가 일치하지 않거나 인증번호 확인이 되지 않았습니다.
            ...
            <li>
              <!-- 입력 오류 메시지 -->
              <div class="main-input-error-message"><span class="requiredValue">* 필수 입력 값입니다.</span><span>* 형식이 올바르지
                  않습니다.</span></div>
              <!-- 입력 컨테이너 -->
              <div class="main-input-list">

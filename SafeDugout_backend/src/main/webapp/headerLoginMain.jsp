  ...
  <div class="header-container">
    ...
    <div class="header-right">
      ...
      <div class="trade-logo">
        <a href="${pageContext.request.contextPath}/app/trade/productRegister.html"><img src="${pageContext.request.contextPath}/assets/img/communityImg/tradeLogo.png" alt=""></a>
      </div>
      <div class="welcome">조성재님 환영합니다.</div>
      <div class="logout"><a href="${pageContext.request.contextPath}/mainNoLogin.html">| logout</a></div>
      <div class="mypage">
        <a href="${pageContext.request.contextPath}/app/myPostList/myPostList.html"><img src="${pageContext.request.contextPath}/assets/img/communityImg/icoMypage.png" alt=""></a>
      </div>
    </div>
  </div>
</header>

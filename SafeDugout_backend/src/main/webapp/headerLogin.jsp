...
<header>
  <div class="header-container">
    ...
    <div class="header-right">
      ...
      <div class="trade-logo"><a href="${pageContext.request.contextPath}/app/trade/productRegister.jsp"> <img
      ...
      <div class="mypage"><a href="${pageContext.request.contextPath}/app/myPostList/myPostList.jsp"><img

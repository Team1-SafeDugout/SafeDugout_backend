...
const noEmailMessage = document.querySelector('.main-input-list:nth-child(2) span:first-child');
const noPhoneNumberMessage = document.querySelector('.main-input-list:nth-child(3) span:first-child');
// 인증번호 일치하지 않거나 인증번호 확인 안 되었을 경우 메시지
const codeMismatchMessage = document.querySelector('.main-input-list:nth-child(4) span');

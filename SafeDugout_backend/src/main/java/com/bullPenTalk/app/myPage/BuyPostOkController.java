...
public class BuyPostOkController implements Execute{
	...
	public Result execute(HttpServletRequest request, HttpServletResponse response)
			...
			System.out.println("BuyPostOkController 진입");
			...
			// 판매글 목록 조회
			List<TradePostDTO> buyPostList = MyPageDAO.selectList(pageMap);
			...
			System.out.println("buyPostList : " + buyPostList);

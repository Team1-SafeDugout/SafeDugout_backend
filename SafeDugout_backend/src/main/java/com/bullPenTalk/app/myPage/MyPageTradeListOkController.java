...
public class MyPageTradeListOkController implements Execute{
	...
	public Result execute(HttpServletRequest request, HttpServletResponse response)
		...
		// 여기에 글목록
		List<MyPageTradeListDTO> boardList = myPageDAO.selectTradeList(pageMap);
		request.setAttribute("boardList", boardList);
		total = myPageDAO.getTotalTrade(memberNumber);

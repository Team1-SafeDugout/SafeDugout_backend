...
public class AdminTeamSongListOkController implements Execute{

	@Override
	public Result execute(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		AdminTeamSongDAO adminTeamSongDAO = new AdminTeamSongDAO();
		...
		int total = adminTeamSongDAO.getTotal();
		...
		result.setPath("/app/admin/adminMenu/adminManageTeamSong.jsp");

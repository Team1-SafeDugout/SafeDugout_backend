...
public class AdminTeamYoutubeListOkController implements Execute{
	...
	public Result execute(HttpServletRequest request, HttpServletResponse response)
		...
		AdminTeamYoutubeDAO adminTeamYoutubeDAO = new AdminTeamYoutubeDAO();
		...
		int total = adminTeamYoutubeDAO.getTotal();
		...
		result.setPath("/app/admin/adminMenu/adminManageTeamYoutube.jsp");
